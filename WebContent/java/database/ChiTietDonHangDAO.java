	...
	public ArrayList<ChiTietDonHang> selectAll() {
		...
		try {
			...
			while (rs.next()) {
				...
				DonHang dh = new DonHangDAO().selectById(new DonHang(madonhang, null, null, null, null, null, 0, 0, null, null));
				SanPham sp = new SanPhamDAO().selectById(new SanPham(masanpham, null, null, 0, 0, 0, 0, 0, null, null, null));
