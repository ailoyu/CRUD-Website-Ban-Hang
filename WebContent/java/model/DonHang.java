...
public class DonHang {
	...
	private String diaChiMuaHang; 	// Có thể tách ra class riêng để có (quận, huyện, xã, phường, tp...)
	private String diaChiNhanHang;	// Có thể tách ra class riêng để có (quận, huyện, xã, phường, tp...) 
